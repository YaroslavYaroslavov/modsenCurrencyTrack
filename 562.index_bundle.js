"use strict";
(self["webpackChunkmodsencurtrack"] = self["webpackChunkmodsencurtrack"] || []).push([[562],{
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/components/pages/Homepage/Converter/styled.css
var Converter_styled = __webpack_require__(2962);
;// CONCATENATED MODULE: ./src/components/pages/Homepage/Converter/styled.css
...
var calculateValue = function calculateValue(leftCurrencyCode, rightCurrencyCode, converterInput) {
  if (data) {
    return Number(converterInput) / data.data[leftCurrencyCode].value * data.data[rightCurrencyCode].value;
  } else return 0;
};
