"use strict";
(self["webpackChunkmodsencurtrack"] = self["webpackChunkmodsencurtrack"] || []).push([[347],{
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/components/Homepage/Converter/styled.css
var Converter_styled = __webpack_require__(9350);
;// CONCATENATED MODULE: ./src/components/Homepage/Converter/styled.css
...
var styled_update = injectStylesIntoStyleTag_default()(Converter_styled/* default */.Z, styled_options);




       /* harmony default export */ const Homepage_Converter_styled = (Converter_styled/* default */.Z && Converter_styled/* default */.Z.locals ? Converter_styled/* default */.Z.locals : undefined);
...
;// CONCATENATED MODULE: ./src/components/Homepage/Converter/CurrencySelect/index.jsx
...
;// CONCATENATED MODULE: ./src/components/Homepage/Converter/index.jsx
...
var Converter = function Converter(_ref) {
  ...
  var calculateValue = function calculateValue(leftCurrencyCode, rightCurrencyCode) {
    return Number(converterInput.current.value) / data.data[leftCurrencyCode].value * data.data[rightCurrencyCode].value;
  };
  var handleChangeCurrencyFrom = function handleChangeCurrencyFrom(e) {
    var selectedCurrency = e.target.value;
    setFromCurrencyCode(currencyIcons/* default */.Z[selectedCurrency].code);
    handleChangeCurrency(selectedCurrency);
    setToCurrencyValue(calculateValue(currencyIcons/* default */.Z[selectedCurrency].code, toCurrencyCode));
  };
  var handleChangeCurrencyTo = function handleChangeCurrencyTo(e) {
    var selectedCurrency = e.target.value;
    setToCurrencyCode(currencyIcons/* default */.Z[selectedCurrency].code);
    setToCurrencyValue(calculateValue(fromCurrencyCode, currencyIcons/* default */.Z[selectedCurrency].code));
  };
...
var CurrencyCard_styled_options = {};

CurrencyCard_styled_options.styleTagTransform = (styleTagTransform_default());
CurrencyCard_styled_options.setAttributes = (setAttributesWithoutAttributes_default());

      CurrencyCard_styled_options.insert = insertBySelector_default().bind(null, "head");
    
CurrencyCard_styled_options.domAPI = (styleDomAPI_default());
CurrencyCard_styled_options.insertStyleElement = (insertStyleElement_default());

var CurrencyCard_styled_update = injectStylesIntoStyleTag_default()(CurrencyCard_styled/* default */.Z, CurrencyCard_styled_options);
